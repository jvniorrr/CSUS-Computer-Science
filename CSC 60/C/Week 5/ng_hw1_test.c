...
int main()
{
	...
	while (questionsAnswered < 5)
	{
		...
		while (alreadyAsked == 1)
		{
			...
			for (i = 0; i < 5; i++)
			{
				if (questionNum == (int) answerArray[i])
				{
		...
		{   
			...
			case 1:
				answer = q1();
                checkAnswer(answer);
				answerArray[arrCount] = 1;
				arrCount++;
				break;
			case 2:
				answer = q2();
                checkAnswer(answer);
				answerArray[arrCount] = 2;
				arrCount++;
				break;
			case 3:
				answer = q3();
                checkAnswer(answer);
				answerArray[arrCount] = 3;
				arrCount++;
				break;
			case 4:
				answer = q4();
                checkAnswer(answer);
				answerArray[arrCount] = 4;
				arrCount++;
				break;
			case 5:
				answer = q5();
                checkAnswer(answer);
				answerArray[arrCount] = 5;
				arrCount++;
				break;
			case 6:
				answer = q6();
                checkAnswer(answer);
				answerArray[arrCount] = 6;
				arrCount++;
				break;
			case 7:
				answer = q7();
                checkAnswer(answer);
				answerArray[arrCount] = 7;
				arrCount++;
				break;
			case 8:
				answer = q8();
                checkAnswer(answer);
				answerArray[arrCount] = 8;
				arrCount++;
				break;
			case 9:
				answer = q9();
                checkAnswer(answer);
				answerArray[arrCount] = 9;
				arrCount++;
				break;
			case 10:
				answer = q10();
                checkAnswer(answer);
				answerArray[arrCount] = 10;
				arrCount++;
				break;
			case 11:
				answer = q11();
                checkAnswer(answer);
				answerArray[arrCount] = 11;
				arrCount++;
				break;
			case 12:
				answer = q12();
                checkAnswer(answer);
				answerArray[arrCount] = 12;
				arrCount++;
				break;
			case 13:
				answer = q13();
                checkAnswer(answer);
				answerArray[arrCount] = 13;
				arrCount++;
				break;
			case 14:
				answer = q14();
                checkAnswer(answer);
				answerArray[arrCount] = 14;
				arrCount++;
				break;
			case 15:
				answer = q15();
                checkAnswer(answer);
				answerArray[arrCount] = 15;
				arrCount++;
				break;
